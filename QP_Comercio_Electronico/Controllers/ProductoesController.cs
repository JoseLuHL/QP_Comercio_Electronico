...
namespace QP_Comercio_Electronico.Controllers
{
    ...
    public class ProductoesController : ControllerBase
    {
        ...
        public ProductoesController(JosephTutos_PedidosContext context)
        {
            _context = context;
        }
        ...
        [HttpGet("tienda/{id}")]
        public async Task<ActionResult<IEnumerable<Producto>>> GetProductoTienda(int id)
        {
            var producto = await _context.Productos
                .Include(s => s.ProdIdcategoriaNavigation)
                .ThenInclude(s => s.SubcatIdcategoriaNavigation)
        ...
        {
            return _context.Productos.Any(e => e.ProdId == id);
        }
    }
}
